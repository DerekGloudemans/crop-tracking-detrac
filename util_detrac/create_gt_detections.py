    ...
    def parse_labels(self,label_file):
        ...
        for frame in frames:
            ...
            for boxid in boxids:
                ...
                outstring = "{},{},{},{},{},{},{}\n".format(frame.attrib["num"],class_dict[stats["vehicle_type"]], coords['left'],coords['top'],coords['width'],coords['height'],1.0)
                
                output_list.append(outstring)
        ...
        id_num = int((label_file.split("_")[1]).split(".")[0])
        output_name = "MVI_{}_Det_groundtruth.txt".format(id_num)
